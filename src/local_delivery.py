...
def check_open_relay(host='198.51.100.186'):
	# Adjust to match domain of sending host!
	sndr = 'OpenRelayTest@'+HOST
	rcpt = 'OpenRelayTest@'+HOST
	message = """From: OpenRelayTest <OpenRelayTest@{host}>
				To: OpenRelayTest <OpenRelayTest@{host}>
